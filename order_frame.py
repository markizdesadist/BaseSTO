...
class Order:
	def __init__(self):
		self.frame = None
		self.txt_edit_lineEdit_client_owner_name = None
		self.txt_label_order_number = None
		self.txt_label_car_brand = None
		self.txt_label_car_number = None
		self.txt_label_order_number_prefix = None
		self.txt_label_client_name = None
		self.txt_label_car_model = None
		self.txt_edit_lineEdit_client_job_title = None
		self.txt_label_car_vin_code = None
		...
		self.btn_pushButton_order_close = None
		self.btn_pushButton_car_car_choice = None
		self.btn_pushButton_new_car = None
		self.btn_pushButton_print_order = None
		self.checkBox_1_repair_request = None
		self.checkBox_2_application_order = None
		self.checkBox_3_act_of_acceptance = None
		self.checkBox_4_internal_consumption = None
		self.frame_data = None
		self.dateEdit = None
		self.label_client_job_title = None
		self.label_client_name = None
		self.label_client_owner_name = None
		self.label_order_number = None
		self.label_order_number_sep = None
	...
	def print(self):
		new = CreateDB()
		temp = APIAxiomDB()
		if not self.txt_edit_lineEdit_client_owner_name.text() in temp.get_list_driver():
			new.driver_create(
				name=self.txt_edit_lineEdit_client_owner_name.text(),
				job=self.txt_edit_lineEdit_client_job_title.text(),
				company_id=temp.get_client_from_unp(int(self.txt_label_client_identification_number.text())).id
			)

		temp_driver = temp.get_driver(self.txt_edit_lineEdit_client_owner_name.text())
		if not self.current_id:

			new.order_create(
				car_id=temp.get_car_from_id(self.txt_label_car_number.text()).id,
				company_id=temp.get_client_from_unp(int(self.txt_label_client_identification_number.text())).id,
			...
			dict_order = {
				...
				'chk1': self.checkBox_1_repair_request.checkState(),
				'chk2': self.checkBox_2_application_order.checkState(),
				'chk3': self.checkBox_3_act_of_acceptance.checkState(),
				'chk4': self.checkBox_4_internal_consumption.checkState()
			}
	...
	def retranslateUi(self):
		...
		self.dateEdit.setDisplayFormat(_translate("MainWindow", "dM - MMM - yyyy"))
