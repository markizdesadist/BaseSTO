...
class ListWCar:
    ...
    def set_body(self):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 200, 631))
        ...
        self.frame_label.setMaximumSize(QtCore.QSize(200, 30))
        ...
        self.label_list.setMinimumSize(QtCore.QSize(200, 30))
        self.label_list.setMaximumSize(QtCore.QSize(200, 30))
        ...
        self.listWidget_list.setGeometry(QtCore.QRect(0, 0, 200, 557))
        self.listWidget_list.setMinimumSize(QtCore.QSize(200, 0))
        self.listWidget_list.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.frame_btn.setMinimumSize(QtCore.QSize(200, 30))
        self.frame_btn.setMaximumSize(QtCore.QSize(200, 30))
    ...
    def retranslateUi(self):
        ...
        self.label_list.setText(_translate("MainWindow", "Машина клиента"))
